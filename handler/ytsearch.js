...
var YTSearch = /** @class */ (function () {
    ...
    YTSearch.execute = function (targetsong) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        page = _a.sent();
                        return [4 /*yield*/, page.goto("https://www.youtube.com/results?search_query=" + targetsong.replace(/ /g, "+"))];
                    case 3:
                        _a.sent();
                    ...
                    case 5:
                        _a.sent();
                        $ = cheerio_1.default.load(pageData.html);
